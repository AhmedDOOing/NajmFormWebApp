...
export const SMS_TEMPLATES = {
  causerFiling: (reportId: string, url: string) =>
    `نجم: أكمل بلاغ الحادث ${reportId} عبر الرابط\nNajm: complete your accident report ${reportId}\n${url}`,
  affectedAck: (reportId: string, url: string) =>
    `نجم: تم تسجيل بلاغ حادث ${reportId} يخص مركبتك. راجع وأكد عبر الرابط\nNajm: accident report ${reportId} involves your vehicle. Review & respond\n${url}`,
} as const;
